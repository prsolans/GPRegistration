<?php	 	 		 		 	 	 		 		 		 		 		 	
	...
	$count = mysql_num_rows($result);
		...
		$insert = "INSERT INTO gp_reg_sda VALUES ('', '".$timestamp."', '".$team."', '".$team1."', '".$team1_email."', '".$team1_phone."', '".$team2."', '".$team2_email."', '".$team3."', '".$team3_email."', '".$team4."', '".$team4_email."')";
		
		mysql_query($insert);
		
		$to      = 'Pierluigi.Addessi@atkearney.com, joe.cubellis@atkearney.com';
$subject = 'Global Prize Registration';
$message = '<html><h2>Registration Form: SDA 2012</h2><br/>';
