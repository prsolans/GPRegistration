<?php	 	 		 		 	 	 		 		 		 		 		 	
	...
	$query = "SELECT * FROM gp_reg_columbia";
	...
	if ($count>$available) {
		...
		$insert = "INSERT INTO gp_reg_columbia VALUES ('', '".$timestamp."', '".$team."', '".$team1."', '".$team1_email."', '".$team1_phone."', '".$team2."', '".$team2_email."', '".$team3."', '".$team3_email."', '".$team4."', '".$team4_email."')";
		
		mysql_query($insert);
		
		$to      = 'Adam.Coe@atkearney.com';
$subject = 'Global Prize Registration';
$message = '<html><h2>Registration Form: Columbia 2012</h2><br/>';
